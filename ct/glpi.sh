#!/usr/bin/env bash
source <(curl -fsSL https://raw.githubusercontent.com/hochdruckspezialist/ProxmoxVE/main/misc/build.func)
# Copyright (c) 2021-2025 community-scripts ORG
# Author: Nícolas Pastorello (opastorello)
# License: MIT | https://github.com/hochdruckspezialist/ProxmoxVE/raw/main/LICENSE
